    ...
    return (
        <div className="PageStyles">
            ...
            <div className="RealEstatePage">
                ...
                <section>
                    <p>Finding your own little slice of California living doesn’t have to be daunting. We provide expert guidance to avoid getting stuck in a maze of endless home searches and bidding matches. Navigating the most competitive market in real estate is easier with consistent, personalized service from the beginning to the close of escrow and beyond.</p>
                    <br />
